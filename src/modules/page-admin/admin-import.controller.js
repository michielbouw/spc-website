            ...
            $http({
                ...
                .success(function (data1, status, headers, config)
                {
                    ...
                    Api.SpelersClub.query({
                        _id: data.wedstrijd_data.thuisTeamID[0]
                    },function(res) {
                        speler_profiel_thuis = res;

                        Api.SpelersClub.query({
                            _id: data.wedstrijd_data.uitTeamID[0]
                        }, function (res1) {
                            ...
                            if (data) {
                                ...
                                angular.forEach(items.opstelling.thuis, function (value, key) {
                                    if (!value.spelerPhoto) {
                                        if ($filter('filter')(speler_profiel_thuis, {spelerID: value.personID}, true)) {
                                            angular.forEach($filter('filter')(speler_profiel_thuis, {spelerID: value.personID}, true), function (value1, key1) {
                                ...
                                angular.forEach(items.opstelling.uit, function (value, key) {
                                    if (!value.spelerPhoto) {
                                        if ($filter('filter')(speler_profiel_uit, {spelerID: value.personID}, true)) {
                                            angular.forEach($filter('filter')(speler_profiel_uit, {spelerID: value.personID}, true), function (value1, key1) {
                                                if (value1.spelerPhoto) {
                                                    value.spelerPhoto = value1.spelerPhoto;
                                                }
                                            });
                                ...
                                for (k1 = 2; k1 < items.overzicht_lineup.length;) {
                                    ...
                                    if (data.wedstrijd_data.overzicht_lineup[k1].V3 !== ' ') {
                                        if (data.wedstrijd_data.overzicht_lineup[k1 - 1].V4 !== 'BANK') {
                                            value_uit = {};
                                            value_uit.spelerNaam = angular.copy(data.wedstrijd_data.overzicht_lineup[k1].V4).split(" (")[0];
                                            value_uit.rugnummer = angular.copy(data.wedstrijd_data.overzicht_lineup[k1].V3);
                                            if ($filter('filter')(items.spelers_uitteam, {spelerNaam: value_uit.spelerNaam})[0]) {
                                                value_uit.personID = angular.copy($filter('filter')(items.spelers_uitteam, {spelerNaam: value_uit.spelerNaam})[0]).personID;

                                                if ($filter('filter')(speler_profiel_uit, {spelerID: value_uit.personID}, true)) {
                                                    angular.forEach($filter('filter')(speler_profiel_uit, {spelerID: value_uit.personID}, true), function (value1, key1) {
                                                        if (value1.spelerPhoto) {
                                        ...
                                        if (data.wedstrijd_data.overzicht_lineup[k1].V4 !== 'BANK') {
                                            value_uit = {};
                                            value_uit.spelerNaam = angular.copy(data.wedstrijd_data.overzicht_lineup[k1 + 1].V4).split(" (")[0];
                                            value_uit.rugnummer = angular.copy(data.wedstrijd_data.overzicht_lineup[k1 + 1].V3);
                                            if ($filter('filter')(items.spelers_uitteam, {spelerNaam: value_uit.spelerNaam})[0]) {
                                                value_uit.personID = angular.copy($filter('filter')(items.spelers_uitteam, {spelerNaam: value_uit.spelerNaam})[0]).personID;
                                        ...
                                        if (data.wedstrijd_data.overzicht_lineup[k1 + 1].V4 !== 'BANK') {
                                            value_uit = {};
                                            value_uit.spelerNaam = angular.copy(data.wedstrijd_data.overzicht_lineup[k1 + 2].V4).split(" (")[0];
                                            value_uit.rugnummer = angular.copy(data.wedstrijd_data.overzicht_lineup[k1 + 2].V3);
                                            if ($filter('filter')(items.spelers_uitteam, {spelerNaam: value_uit.spelerNaam})[0]) {
                                                value_uit.personID = angular.copy($filter('filter')(items.spelers_uitteam, {spelerNaam: value_uit.spelerNaam})[0]).personID;
                                        ...
                                        if (data.wedstrijd_data.overzicht_lineup[k1 + 2].V4 !== 'BANK') {
                                            value_uit = {};
                                            value_uit.spelerNaam = angular.copy(data.wedstrijd_data.overzicht_lineup[k1 + 3].V4).split(" (")[0];
                                            value_uit.rugnummer = angular.copy(data.wedstrijd_data.overzicht_lineup[k1 + 3].V3);
                                            if ($filter('filter')(items.spelers_uitteam, {spelerNaam: value_uit.spelerNaam})[0]) {
                                                value_uit.personID = angular.copy($filter('filter')(items.spelers_uitteam, {spelerNaam: value_uit.spelerNaam})[0]).personID;
                                        ...
                                        if (data.wedstrijd_data.overzicht_lineup[k1 + 3].V4 !== 'BANK') {
                                            value_uit = {};
                                            value_uit.spelerNaam = angular.copy(data.wedstrijd_data.overzicht_lineup[k1 + 4].V4).split(" (")[0];
                                            value_uit.rugnummer = angular.copy(data.wedstrijd_data.overzicht_lineup[k1 + 4].V3);
                                            if ($filter('filter')(items.spelers_uitteam, {spelerNaam: value_uit.spelerNaam})[0]) {
                                                value_uit.personID = angular.copy($filter('filter')(items.spelers_uitteam, {spelerNaam: value_uit.spelerNaam})[0]).personID;
                                        ...
                                        if (data.wedstrijd_data.overzicht_lineup[k1 + 4].V4 !== 'BANK') {
                                            value_uit = {};
                                            value_uit.spelerNaam = angular.copy(data.wedstrijd_data.overzicht_lineup[k1 + 5].V4).split(" (")[0];
                                            value_uit.rugnummer = angular.copy(data.wedstrijd_data.overzicht_lineup[k1 + 5].V3);
                                            if ($filter('filter')(items.spelers_uitteam, {spelerNaam: value_uit.spelerNaam})[0]) {
                                                value_uit.personID = angular.copy($filter('filter')(items.spelers_uitteam, {spelerNaam: value_uit.spelerNaam})[0]).personID;
                                        ...
                                        if (data.wedstrijd_data.overzicht_lineup[k1 + 5].V4 !== 'BANK') {
                                            value_uit = {};
                                            value_uit.spelerNaam = angular.copy(data.wedstrijd_data.overzicht_lineup[k1 + 6].V4).split(" (")[0];
                                            value_uit.rugnummer = angular.copy(data.wedstrijd_data.overzicht_lineup[k1 + 6].V3);
                                            if ($filter('filter')(items.spelers_uitteam, {spelerNaam: value_uit.spelerNaam})[0]) {
                                                value_uit.personID = angular.copy($filter('filter')(items.spelers_uitteam, {spelerNaam: value_uit.spelerNaam})[0]).personID;
                                ...
                                if (data.team_data) {
                                    ...
                                    angular.forEach(data.wedstrijd_data.spelers_thuisteam, function (value, key) {
                                        if (data.team_data.pass_matrix_kwartier1) {
                                            angular.forEach(items.pass_matrix_kwartier1.thuis.passMatrix, function (value1, key1) {
                                                if (Number(value1._row) === value.personID) {
                                                    value1._row = angular.copy(value.spelerNaam);
                                                    items.pass_matrix_kwartier1_thuis_spelers.push(value);
                                                }
                                            });
                                            angular.forEach(items.pass_matrix_kwartier1.thuis.passMatrix2, function (value1, key1) {
                                                if (Number(value1._row) === value.personID) {
                                                    value1._row = angular.copy(value.spelerNaam);
                                                }
                                            });
                                        ...
                                        if (data.team_data.pass_matrix_kwartier2) {
                                            angular.forEach(items.pass_matrix_kwartier2.thuis.passMatrix, function (value1, key1) {
                                                if (Number(value1._row) === value.personID) {
                                                    value1._row = angular.copy(value.spelerNaam);
                                                    items.pass_matrix_kwartier2_thuis_spelers.push(value);
                                                }
                                            });
                                            angular.forEach(items.pass_matrix_kwartier2.thuis.passMatrix2, function (value1, key1) {
                                                if (Number(value1._row) === value.personID) {
                                                    value1._row = angular.copy(value.spelerNaam);
                                                }
                                            });
                                        ...
                                        if (data.team_data.pass_matrix_kwartier3) {
                                            angular.forEach(items.pass_matrix_kwartier3.thuis.passMatrix, function (value1, key1) {
                                                if (Number(value1._row) === value.personID) {
                                                    value1._row = angular.copy(value.spelerNaam);
                                                    items.pass_matrix_kwartier3_thuis_spelers.push(value);
                                                }
                                            });
                                            angular.forEach(items.pass_matrix_kwartier3.thuis.passMatrix2, function (value1, key1) {
                                                if (Number(value1._row) === value.personID) {
                                                    value1._row = angular.copy(value.spelerNaam);
                                                }
                                            });
                                        ...
                                        if (data.team_data.pass_matrix_kwartier4) {
                                            angular.forEach(items.pass_matrix_kwartier4.thuis.passMatrix, function (value1, key1) {
                                                if (Number(value1._row) === value.personID) {
                                                    value1._row = angular.copy(value.spelerNaam);
                                                    items.pass_matrix_kwartier4_thuis_spelers.push(value);
                                                }
                                            });
                                            angular.forEach(items.pass_matrix_kwartier4.thuis.passMatrix2, function (value1, key1) {
                                                if (Number(value1._row) === value.personID) {
                                                    value1._row = angular.copy(value.spelerNaam);
                                                }
                                            });
                                        ...
                                        if (data.team_data.pass_matrix_kwartier5) {
                                            angular.forEach(items.pass_matrix_kwartier5.thuis.passMatrix, function (value1, key1) {
                                                if (Number(value1._row) === value.personID) {
                                                    value1._row = angular.copy(value.spelerNaam);
                                                    items.pass_matrix_kwartier5_thuis_spelers.push(value);
                                                }
                                            });
                                            angular.forEach(items.pass_matrix_kwartier5.thuis.passMatrix2, function (value1, key1) {
                                                if (Number(value1._row) === value.personID) {
                                                    value1._row = angular.copy(value.spelerNaam);
                                                }
                                            });
                                        ...
                                        if (data.team_data.pass_matrix_kwartier6) {
                                            angular.forEach(items.pass_matrix_kwartier6.thuis.passMatrix, function (value1, key1) {
                                                if (Number(value1._row) === value.personID) {
                                                    value1._row = angular.copy(value.spelerNaam);
                                                    items.pass_matrix_kwartier6_thuis_spelers.push(value);
                                                }
                                            });
                                            angular.forEach(items.pass_matrix_kwartier6.thuis.passMatrix2, function (value1, key1) {
                                                if (Number(value1._row) === value.personID) {
                                                    value1._row = angular.copy(value.spelerNaam);
                                                }
                                            });
                                    ...
                                    angular.forEach(data.wedstrijd_data.spelers_uitteam, function (value, key) {
                                        if (data.team_data.pass_matrix_kwartier1) {
                                            angular.forEach(items.pass_matrix_kwartier1.uit.passMatrix, function (value1, key1) {
                                                if (Number(value1._row) === value.personID) {
                                                    value1._row = angular.copy(value.spelerNaam);
                                                    items.pass_matrix_kwartier1_uit_spelers.push(value);
                                                }
                                            });
                                            angular.forEach(items.pass_matrix_kwartier1.uit.passMatrix2, function (value1, key1) {
                                                if (Number(value1._row) === value.personID) {
                                                    value1._row = angular.copy(value.spelerNaam);
                                                }
                                            });
                                        ...
                                        if (data.team_data.pass_matrix_kwartier2) {
                                            angular.forEach(items.pass_matrix_kwartier2.uit.passMatrix, function (value1, key1) {
                                                if (Number(value1._row) === value.personID) {
                                                    value1._row = angular.copy(value.spelerNaam);
                                                    items.pass_matrix_kwartier2_uit_spelers.push(value);
                                                }
                                            });
                                            angular.forEach(items.pass_matrix_kwartier2.uit.passMatrix2, function (value1, key1) {
                                                if (Number(value1._row) === value.personID) {
                                                    value1._row = angular.copy(value.spelerNaam);
                                                }
                                            });
                                        ...
                                        if (data.team_data.pass_matrix_kwartier3) {
                                            angular.forEach(items.pass_matrix_kwartier3.uit.passMatrix, function (value1, key1) {
                                                if (Number(value1._row) === value.personID) {
                                                    value1._row = angular.copy(value.spelerNaam);
                                                    items.pass_matrix_kwartier3_uit_spelers.push(value);
                                                }
                                            });
                                            angular.forEach(items.pass_matrix_kwartier3.uit.passMatrix2, function (value1, key1) {
                                                if (Number(value1._row) === value.personID) {
                                                    value1._row = angular.copy(value.spelerNaam);
                                                }
                                            });
                                        ...
                                        if (data.team_data.pass_matrix_kwartier4) {
                                            angular.forEach(items.pass_matrix_kwartier4.uit.passMatrix, function (value1, key1) {
                                                if (Number(value1._row) === value.personID) {
                                                    value1._row = angular.copy(value.spelerNaam);
                                                    items.pass_matrix_kwartier4_uit_spelers.push(value);
                                                }
                                            });
                                            angular.forEach(items.pass_matrix_kwartier4.uit.passMatrix2, function (value1, key1) {
                                                if (Number(value1._row) === value.personID) {
                                                    value1._row = angular.copy(value.spelerNaam);
                                                }
                                            });
                                        ...
                                        if (data.team_data.pass_matrix_kwartier5) {
                                            angular.forEach(items.pass_matrix_kwartier5.uit.passMatrix, function (value1, key1) {
                                                if (Number(value1._row) === value.personID) {
                                                    value1._row = angular.copy(value.spelerNaam);
                                                    items.pass_matrix_kwartier5_uit_spelers.push(value);
                                                }
                                            });
                                            angular.forEach(items.pass_matrix_kwartier5.uit.passMatrix2, function (value1, key1) {
                                                if (Number(value1._row) === value.personID) {
                                                    value1._row = angular.copy(value.spelerNaam);
                                                }
                                            });
                                        ...
                                        if (data.team_data.pass_matrix_kwartier6) {
                                            angular.forEach(items.pass_matrix_kwartier6.uit.passMatrix, function (value1, key1) {
                                                if (Number(value1._row) === value.personID) {
                                                    value1._row = angular.copy(value.spelerNaam);
                                                    items.pass_matrix_kwartier6_uit_spelers.push(value);
                                                }
                                            });
                                            angular.forEach(items.pass_matrix_kwartier6.uit.passMatrix2, function (value1, key1) {
                                                if (Number(value1._row) === value.personID) {
                                                    value1._row = angular.copy(value.spelerNaam);
                                                }
                                            });
                                    ...
                                    angular.forEach(data.thuisSpelers_data, function (value, key) {
                                        ...
                                        angular.forEach(items.spelersthuisteam, function (value1, key1) {
                                            if (value1.personID == value.speler[0]) {
                                                ...
                                                temp.spelerPhoto = angular.copy(value1.spelerPhoto);
                                            }
                                        });
                                        if (temp.type == 'keeper') {
                                        ...
                                        Api.TeamDataItem.get({
                                            ...
                                            if (!teamdata.team_slug) {
                                                ...
                                                Api.TeamData.post(teamdata, function () {
                                                    ...
                                                    $rootScope.errorImport = 'Oeps er ging iets mis, teamdata thuis (POST) niet geimporteerd';
                                                });
                                            } else {
                                                ...
                                                if (teamdata.player_data) {
                                                    angular.forEach(player_data.player_stats_thuis, function (value, key) {
                                                        if (!($filter('filter')(teamdata.player_data, {playerID: value.personID})[0])) {
                                                            var temp = {};
                                                            temp.playerID = value.personID;
                                                            temp.spelerNaam = value.spelerNaam;
                                                            temp.spelerType = value.type;
                                                            ...
                                                            angular.forEach(teamdata.player_data, function (value1, key1) {
                                                ...
                                                Api.TeamDataItem.put({
                                                    ...
                                                    $rootScope.errorImport = 'Oeps er ging iets mis, teamdata thuis (PUT) niet geimporteerd';
                                                });
                                            }
                                        });
                                    });
                                        ...
                                        Api.TeamDataItem.get({
                                            ...
                                            if (!teamdata_uit.team_slug) {
                                                ...
                                                Api.TeamData.post(teamdata_uit, function () {
                                                    ...
                                                    $rootScope.errorImport = 'Oeps er ging iets mis, teamdata uit (POST) niet geimporteerd';
                                                });
                                            } else {
                                                ...
                                                if (teamdata_uit.player_data) {
                                                    angular.forEach(player_data.player_stats_uit, function (value, key) {
                                                        if (!($filter('filter')(teamdata_uit.player_data, {playerID: value.personID})[0])) {
                                                            var temp = {};
                                                            temp.playerID = value.personID;
                                                            temp.spelerNaam = value.spelerNaam;
                                                            temp.spelerType = value.type;
                                                            ...
                                                            angular.forEach(teamdata_uit.player_data, function (value1, key1) {
                                                                if (value.personID == value1.playerID && value.type == value1.spelerType) {
                                                                    value1.spelerNaam = value.spelerNaam;
                                                                    value1.spelerRugnummer = value.rugnummer;
                                                                    value1.spelerPhoto = value.spelerPhoto;
                                                ...
                                                Api.TeamDataItem.put({
                                                    ...
                                                    $rootScope.errorImport = 'Oeps er ging iets mis, teamdata uit (PUT) niet geimporteerd';
                                                });
                                            }
                                        });
                                    });
