angular.module('mainapp.pageAdmin')
    .controller('mainapp.pageAdmin.AdminUsersEditController', ['Api', '$scope', '$uibModal', '$routeParams', '$location', '$rootScope',
        function(Api, $scope, $uibModal, $routeParams, $location, $rootScope) {
