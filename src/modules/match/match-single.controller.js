        ...
        function($scope, $filter, Api, AuthenticationService, $location, $rootScope, $routeParams, $sessionStorage)
    {
        ...
        Api.MatchDataID.get({
            ...
            if ($sessionStorage.currentClub) {
                ...
                teamslug = '';
                if (teams[0].team_slug == self.match.thuisTeamSlug || teams[1].team_slug == self.match.thuisTeamSlug) {
                ...
                } else if (teams[0].team_slug == self.match.uitTeamSlug || teams[1].team_slug == self.match.uitTeamSlug) {
