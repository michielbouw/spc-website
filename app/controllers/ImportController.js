...
module.exports = ImportController = {
    ...
    match : function(file_path)
    {
        ...
        fs.readFile(file_path, function handleFile(err, data1) {
            if (err) throw err;
            ...
            Spelers.find({clubID: data.wedstrijd_data.thuisTeamID[0]}, function(err, res){
                ...
                Spelers.find({clubID: data.wedstrijd_data.uitTeamID[0]}, function(err1, res1){
                    ...
                    if (data) {
                        ...
                        team_data.thuis = {};
                        team_data.uit = {};
                        team_data.thuis.matchID = Number(items.matchID);
                        team_data.uit.matchID = Number(items.matchID);
                        team_data.thuis.ronde = Number(match_short.match_info.ronde);
                        team_data.uit.ronde = Number(match_short.match_info.ronde);
                        ...
                        if (data.team_data) {
                            team_data.thuis.balbezit = Number(_.where(data.team_matrix, {_row: 'Balbezit'})[0][items.thuisTeamID].split("%", 1)[0]);
                            team_data.uit.balbezit = Number(_.where(data.team_matrix, {_row: 'Balbezit'})[0][items.uitTeamID].split("%", 1)[0]);
                            team_data.thuis.tot_passes = Number(_.where(data.team_matrix, {_row: 'Tot. aantal passes'})[0][items.thuisTeamID]);
                            team_data.uit.tot_passes = Number(_.where(data.team_matrix, {_row: 'Tot. aantal passes'})[0][items.uitTeamID]);
                            team_data.thuis.geslaagde_passes = Number(_.where(data.team_matrix, {_row: 'Geslaagde passes'})[0][items.thuisTeamID].split("%", 1)[0]);
                            team_data.uit.geslaagde_passes = Number(_.where(data.team_matrix, {_row: 'Geslaagde passes'})[0][items.uitTeamID].split("%", 1)[0]);
                            team_data.thuis.lengte_passes = Number(_.where(data.team_matrix, {_row: 'Gem. lengte passes'})[0][items.thuisTeamID].split(" m.", 1)[0]);
                            team_data.uit.lengte_passes = Number(_.where(data.team_matrix, {_row: 'Gem. lengte passes'})[0][items.uitTeamID].split(" m.", 1)[0]);
                            team_data.thuis.doelpogingen = Number(_.where(data.team_matrix, {_row: 'Doelpogingen'})[0][items.thuisTeamID]);
                            team_data.uit.doelpogingen = Number(_.where(data.team_matrix, {_row: 'Doelpogingen'})[0][items.uitTeamID]);
                            team_data.thuis.gewonnen_duels = Number(_.where(data.team_matrix, {_row: 'Gewonnen duels'})[0][items.thuisTeamID].split("%", 1)[0]);
                            team_data.uit.gewonnen_duels = Number(_.where(data.team_matrix, {_row: 'Gewonnen duels'})[0][items.uitTeamID].split("%", 1)[0]);
                            team_data.thuis.geel = Number(_.where(data.team_matrix, {_row: 'Gele kaarten'})[0][items.thuisTeamID]);
                            team_data.uit.geel = Number(_.where(data.team_matrix, {_row: 'Gele kaarten'})[0][items.uitTeamID]);
                            team_data.thuis.rood = Number(_.where(data.team_matrix, {_row: 'Rode kaarten'})[0][items.thuisTeamID]);
                            team_data.uit.rood = Number(_.where(data.team_matrix, {_row: 'Rode kaarten'})[0][items.uitTeamID]);
                        } else {
                            team_data.thuis.balbezit = Number(data.wedstrijd_data.balbezit.hele_wedstrijd[0][items.thuisTeamID]);
                            team_data.uit.balbezit = Number(data.wedstrijd_data.balbezit.hele_wedstrijd[0][items.uitTeamID]);
                            team_data.thuis.geel = Number(data.wedstrijd_data.overzicht_wedstrijdstatistieken[6][' ']);
                            team_data.uit.geel = Number(data.wedstrijd_data.overzicht_wedstrijdstatistieken[6][' .2']);
                            team_data.thuis.rood = Number(data.wedstrijd_data.overzicht_wedstrijdstatistieken[7][' ']);
                            team_data.uit.rood = Number(data.wedstrijd_data.overzicht_wedstrijdstatistieken[7][' .2']);
                        }
                        ...
                        if (items.matchID >= 1203 && items.matchID <= 1582) {
                            ...
                            if (items.matchID >= 6507 && items.matchID <= 6510) {
                                match_short.match_info.ronde = Number(match_short.match_info.ronde) + 2;
                                items.ronde = match_short.match_info.ronde;
                                team_data.thuis.ronde = Number(match_short.match_info.ronde);
                                team_data.uit.ronde = Number(match_short.match_info.ronde);
                            }
                            if (items.matchID >= 6515 && items.matchID <= 6518) {
                                match_short.match_info.ronde = Number(match_short.match_info.ronde) + 4;
                                items.ronde = match_short.match_info.ronde;
                                team_data.thuis.ronde = Number(match_short.match_info.ronde);
                                team_data.uit.ronde = Number(match_short.match_info.ronde);
                            }
                        ...
                        if (data.team_data) {
                            ...
                            forEach(data.wedstrijd_data.spelers_thuisteam, function (value, key) {
                                forEach(items.duel_matrix_hele_wedstrijd.thuis, function (value1, key1) {
                                    if (Number(value1['1']) === value.personID) value1['1'] = value.spelerNaam;
                                });
                                var del = true;
                            ...
                            if (data.team_data.pass_matrix_kwartier1) {
                            ...
                            if (data.team_data.pass_matrix_kwartier2) {
                            ...
                            if (data.team_data.pass_matrix_kwartier3) {
                            ...
                            if (data.team_data.pass_matrix_kwartier4) {
                            ...
                            if (data.team_data.pass_matrix_kwartier5) {
                            ...
                            if (data.team_data.pass_matrix_kwartier6) {
                        ...
                        if (data.thuisSpelers_data) {
                            ...
                            forEach(data.thuisSpelers_data, function (value, key) {
                                var temp = {};
                                temp.matchID = Number((items.matchID));
                                ...
                                temp.ronde = Number(match_short.match_info.ronde);
                                temp.teamID = (items.thuisTeamID);
                                temp.type = (value.stat_matrix.type[0]);
                                temp.personID = (value.speler[0]);
                                forEach(items.spelersthuisteam, function (value1, key1) {
                                    if (value1.personID == value.speler[0]) {
                                        temp.spelerNaam = (value1.spelerNaam);
                                        temp.rugnummer = Number((value1.rugnummer));
                                        temp.spelerPhoto = (value1.spelerPhoto);
                                    }
                                });
                                if (temp.type == 'keeper') {
                                    temp.minuten = Number(_.where(value.stat_matrix.speler_mat, {_row: 'Minuten'})[0][temp.personID]);
                                    temp.reddingen = Number(_.where(value.stat_matrix.speler_mat, {_row: 'Reddingen'})[0][temp.personID]);
                                    temp.geslaagde_reddingen = Number(_.where(value.stat_matrix.speler_mat, {_row: 'Geslaagde reddingen'})[0][temp.personID].split("%")[0]);
                                    temp.korte_passes = Number(_.where(value.stat_matrix.speler_mat, {_row: 'Aantal korte passes'})[0][temp.personID]);
                                    temp.middellange_passes = Number(_.where(value.stat_matrix.speler_mat, {_row: 'Aantal middellange passes'})[0][temp.personID]);
                                    temp.lange_passes = Number(_.where(value.stat_matrix.speler_mat, {_row: 'Aantal lange passes'})[0][temp.personID]);
                                    temp.pass_percentage = Number(_.where(value.stat_matrix.speler_mat, {_row: 'Geslaagde passes'})[0][temp.personID].split("%")[0]);
                                    temp.gevangen_ballen = Number(_.where(value.stat_matrix.speler_mat, {_row: 'Gevangen ballen'})[0][temp.personID]);
                                    temp.weggestompte_ballen = Number(_.where(value.stat_matrix.speler_mat, {_row: 'Weggestompte ballen'})[0][temp.personID]);
                                    temp.succesvolle_uittrappen = Number(_.where(value.stat_matrix.speler_mat, {_row: 'Succesvolle uittrappen'})[0][temp.personID].split("%")[0]);
                                    temp.geel = Number(_.where(value.stat_matrix.speler_mat, {_row: 'Gele kaarten'})[0][temp.personID]);
                                    temp.rood = Number(_.where(value.stat_matrix.speler_mat, {_row: 'Rode kaart'})[0][temp.personID]);
                                    ...
                                    temp.minuten = Number(_.where(value.stat_matrix.speler_mat, {_row: 'Minuten'})[0][temp.personID]);
                                    temp.doelpunten = Number(_.where(value.stat_matrix.speler_mat, {_row: 'Doelpunten'})[0][temp.personID]);
                                    temp.aantal_passes = Number(_.where(value.stat_matrix.speler_mat, {_row: 'Aantal passes'})[0][temp.personID]);
                                    temp.geslaagde_passes = Number(_.where(value.stat_matrix.speler_mat, {_row: 'Geslaagde passes'})[0][temp.personID]);
                                    temp.pass_percentage = Number(((Number(temp.geslaagde_passes) / Number(temp.aantal_passes)) * 100).toFixed(1));
                                    temp.doelpogingen = Number(_.where(value.stat_matrix.speler_mat, {_row: 'Doelpogingen'})[0][temp.personID]);
                                    temp.doelpogingen_opdoel = Number(_.where(value.stat_matrix.speler_mat, {_row: 'Doelpogingen op doel'})[0][temp.personID].split("%")[0]);
                                    temp.voorzetten = Number(_.where(value.stat_matrix.speler_mat, {_row: 'Voorzetten'})[0][temp.personID]);
                                    temp.gewonnen_duels = Number(_.where(value.stat_matrix.speler_mat, {_row: 'Gewonnen duels'})[0][temp.personID].split("%")[0]);
                                    temp.intercepties = Number(_.where(value.stat_matrix.speler_mat, {_row: 'Intercepties'})[0][temp.personID]);
                                    temp.overtredingen = Number(_.where(value.stat_matrix.speler_mat, {_row: 'Overtredingen'})[0][temp.personID]);
                                    temp.geel = Number(_.where(value.stat_matrix.speler_mat, {_row: 'Gele kaarten'})[0][temp.personID]);
                                    temp.rood = Number(_.where(value.stat_matrix.speler_mat, {_row: 'Rode kaart'})[0][temp.personID]);
                                    temp.verdedigende_duels = Number((value.algemene_stats[6][0][0]));
                                    temp.aanvallende_duels = Number((value.algemene_stats[4][0][0]));
                                    temp.pass_lengte = Number((Number(value.pass_soorten_helft1[temp.personID][0].gem_len.split("m")[0]) + Number(value.pass_soorten_helft2[temp.personID][0].gem_len.split("m")[0]) / 2).toFixed(1));
                                }
                            ...
                            forEach(data.thuisSpelers_data, function (value, key) {
                                ...
                                forEach(items.spelersthuisteam, function (value1, key1) {
                                    if (value1.personID == value.speler[0]) {
                                        temp.spelerNaam = (value1.spelerNaam);
                                        temp.spelerRugnummer = Number((value1.rugnummer));
                                        temp.spelerPhoto = (value1.spelerPhoto);
                                    }
                                });
                                if (temp.spelerType == 'keeper') {
                                    ...
                                    temp.doelpunten = Number((value.algemene_stats[1][0][0]));
                                ...
                                temp.eigen_doelpunten = Number((value.algemene_stats[2][0][0]));
                                temp.aantal_acties = Number((value.algemene_stats[3][0][0]));
                                temp.aantal_aanvallende_duels = Number((value.algemene_stats[4][0][0]));
                                temp.aantal_aanvallende_duels_gewonnen = Number((value.algemene_stats[5][0][0]));
                                temp.aantal_verdedigende_duels = Number((value.algemene_stats[6][0][0]));
                                temp.aantal_verdedigende_duels_gewonnen = Number((value.algemene_stats[7][0][0]));
                                temp.assists = Number((value.algemene_stats[8][0][0]));
                                temp.penalties_gescoord = Number((value.algemene_stats[9][0][0]));
                                temp.penalties_gemist = Number((value.algemene_stats[10][0][0]));
                                temp.aantal_buitenspel = Number((value.algemene_stats[11][0][0]));
                                temp.overtredingen_tegen = Number((value.algemene_stats[12][0][0]));
                                temp.overtredingen_mee = Number((value.algemene_stats[13][0][0]));
                                temp.tweede_geel = Number((value.algemene_stats[15][0][0]));
                        ...
                        if (data.uitSpelers_data) {
                            ...
                            forEach(data.uitSpelers_data, function (value, key) {
                                var temp = {};
                                temp.matchID = Number((items.matchID));
                                temp.match = (match_short.match_info.wedstrijd);
                                temp.result = (match_short.match_info.eindstand);
                    ...
                    if (data && match_data) {
                        MatchData.findOne({_id: match_data.matchID}, function(err, res){
                            var matchdata = res;
